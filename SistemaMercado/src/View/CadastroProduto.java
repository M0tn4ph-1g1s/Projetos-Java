	...
	public void actionPerformed(ActionEvent arg) {
		...
		if(arg.getSource().equals(btn1)) {
			...
			try {	
				...
				pro.setNome(txt1.getText());	
						
				int qtd = Integer.parseInt(txt2.getText());
				pro.setQtd(qtd);
			    ...
			    int codigo = 0;
			    for (int i = 0; i < 1 ; i++) {
				    codigo = gerador.nextInt(999999);
				}
				pro.setcodigo(codigo);  
					      					
			    DAOproduto cada = new DAOproduto();
				cada.cadastro(pro);	    	
